...
import com.example.janepaulineeccomerce.activities.DetailedActivity;
...
public class NewProductAdapter extends RecyclerView.Adapter<NewProductAdapter.ViewHolder> {
    ...
    private ArrayList<NewProductsModel> list;

    public NewProductAdapter(Context context, ArrayList<NewProductsModel> list) {
